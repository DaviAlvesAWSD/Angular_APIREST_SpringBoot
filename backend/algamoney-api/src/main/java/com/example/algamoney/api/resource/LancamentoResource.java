...
// --------------------------------------------UPDATE----------------------------------------------------------------------------------------------------------------			
	...
	public ResponseEntity<Lancamento> atualizar(@PathVariable Long codigo, @Validated @RequestBody Lancamento lancamento) throws PessoaInexistenteOuInativaException {
		try {
